...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Rainy X Hub Premium Scripts") then
			makefolder("Rainy X Hub Premium Scripts")
		end
		if not isfolder("Rainy X Hub Premium Scripts/Blox Fruits/") then
			makefolder("Rainy X Premium Scripts/Blox Fruits/")
		end
		if not isfile("Rainy X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Rainy X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Rainy X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Rainy X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Rainy X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
